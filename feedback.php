...
<div class="col-lg-6">
<span class="logo">Geby-Quiz</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:almendo.tetelepta@student.president.ac.id" style="color:#000000">Almendo</a><br /><br />
...
<a href="https://www.facebook.com/the.one.and.only.boy" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="/image/agt.jpg" width=100 height=100 alt="Almendo" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/the.one.and.only.boy" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Almendo Gabriel</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+62 821 9850 5634</h4>
		<h4 style="font-family:'typo' ">almendo.tetelepta@student.president.ac.id</h4>
		<h4 style="font-family:'typo' ">President University</h4></div></div>
		</p>
      </div>
